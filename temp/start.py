...
if __name__ == '__main__':
    ...
    #validate_object = predict.Predict(initial=initial, number_of_x=number_of_x, number_of_y=number_of_y,
    #                                  best_result_models_info=best_result_models_info)
    #validate_object.predict()
